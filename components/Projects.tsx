...
const projects = [
  ...
  },
  {
    ...
    description: "A premium residential and luxury hospitality platform showcasing five-star accommodations, diplomatic-grade security, and VIP services.",
    fullDetails: "Developed a bespoke landing page and presentation platform for Samawet Al Khalej, a luxury hospitality brand. The platform highlights royal accommodation suites, custom VIP safety protocols, gourmet dining, and booking contact channels. Engineered with Next.js, React, and Tailwind CSS for a highly responsive, modern, and fluid user experience that exudes luxury.",
    ...
    color: "from-[#d97706]/30",
    size: "col-span-1 row-span-1",
    liveLink: "https://www.samawetalkhalej.com/",
    codeLink: "#"
  },
  {
    title: "Al Naseem Travels: Saudi Business Hub",
    description: "A comprehensive business consultancy portal facilitating corporate setup, investor licensing, and visa services in Saudi Arabia.",
    fullDetails: "Developed a professional corporate website for Al Naseem Travels, a premier business and investment hub based in Jeddah. The platform streamlines investor trading and service licensing, e-passports, and visa application procedures. Engineered with a responsive React frontend, customized service cards, and real-time WhatsApp contact integration.",
    ...
    liveLink: "https://www.saudibusiness.info/",
    codeLink: "#"
  },
  {
